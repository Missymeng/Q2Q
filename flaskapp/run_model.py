...
def run_model(input_seq):
    ...
    data_path = 'flaskapp/wikiSQL/test_set.csv'
    ...
    # print("input tokens:",input_characters)
    # print("target tokens:",target_characters)
    ...
    model = load_model('flaskapp/model/128_10')
